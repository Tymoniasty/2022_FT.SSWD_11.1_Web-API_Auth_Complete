...
// https://github.com/auth0/express-jwt-authz/issues/47#issuecomment-1250346173

const checkAuth = (permissions) => jwtAuthz(permissions, {customScopeKey: "permissions", customUserKey: 'auth'});
